...
const mealCards = [
  {
    category: 'Burgers',
    meals: [
      { mealName: 'Burger', price: '15,00', desc: 'Juicy burger with bacon' },
...
export default function Page({
  ...
  return (
    <div className="flex flex-col items-center justify-between h-full">
      <div className="relative w-full h-[20vh] mb-6 overflow-hidden border-b-gray-4 border-b-[0.0625rem] shadow-[0_0.125rem_0.25rem_0_rgba(204,209,212,0.4)] select-none">
        <Image
          src={restaurantPic}
      ...
      <div className="flex flex-col items-start w-[92%] md:w-[70%]">
        <Typography
          variant="h4"
          component="h3"
        ...
        <Typography
          variant="body1"
          className="font-display text-gray-3 mb-2"
        >
          {address}
        </Typography>
        <div className="flex justify-start gap-2">
          <Typography
            variant="body1"
            className="w-[6.25rem] font-display font-bold mb-2 whitespace-nowrap"
          >
            Description :
          </Typography>
          <Typography
      ...
      <div className="flex items-center w-[92%] md:w-[70%]">
