...
export function Navbar({ logo, items: iconArray }: NavbarProps): JSX.Element {
  ...
  return (
    <>
      {/* Phone */}
      <div className="ui-flex md:ui-hidden ui-fixed ui-bottom-0 ui-w-full ui-h-12 ui-z-10 ui-border-t-gray-4 ui-border-r-[1px] ui-bg-gray-5 ui-text-gray-3">
      ...
      {/* Computer */}
      <div
        className="ui-hidden ui-sticky ui-top-0 ui-h-screen ui-border-r-gray-4 ui-border-r-[1px] ui-bg-gray-5 ui-text-gray-3 md:ui-flex ui-flex-col ui-items-center hover:ui-w-40 ui-transition-all ui-duration-300 ui-w-16 ui-z-20 ui-select-none"
        {...bind}
      >
